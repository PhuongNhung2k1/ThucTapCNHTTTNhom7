...
<asp:Content ID="Content2" ContentPlaceHolderID="NoiDung" runat="server">
    <asp:DataList ID="DataList1" runat="server" DataKeyField="MaSanPham" DataSourceID="SqlDataSource1" RepeatColumns="5" Width="1145px" style="margin-top: 0px" CellPadding="4" ForeColor="#333333" Height="357px">
    ...
    <ItemTemplate>
        ...
        <a href="Detail.aspx?MaSanPham =<%# Eval("MaSanPham") %>"> 
            <asp:Image ID="hinhanh" runat="server" ImageUrl='<%#Eval("hinhanh") %>' Height="150px" Width="180px" /></a>
        <br /><br />
        ...
        <br /><br />
        <p>      
        <a href="Cart.aspx"><asp:Button ID="bu1" runat="server" Text="Mua hàng" /></a>
        </p>
    </ItemTemplate>
